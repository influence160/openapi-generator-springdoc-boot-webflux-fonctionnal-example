...
public class UserRepositoryImpl implements UserRepository {
	...
	static User newUser(long id, String firstname, String lastname, int age) {
		User user = new User();
		user.setId(id);
	...
	public void init() throws Exception {
		users.put(Long.valueOf(1), newUser(1, "Jack", "Smith", 20));
		users.put(Long.valueOf(2), newUser(2, "Peter", "Johnson", 25));
	}
